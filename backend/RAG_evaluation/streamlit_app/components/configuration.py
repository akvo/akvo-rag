...
class ConfigurationManager:
    ...
    def render_sidebar_config() -> Dict[str, Any]:
        ...
        kb_name = st.sidebar.text_input(
            "Knowledge Base Name", 
            placeholder="Enter your knowledge base name"
        ).strip()
    ...
    def get_current_config() -> Dict[str, Any]:
        ...
        return {
            ...
            'ragas_metric_names': st.session_state.get('ragas_metric_names', []),
    ...
    def log_configuration(config: Dict[str, Any], logger) -> None:
        ...
        safe_config = {
            ...
            'openai_api_key': 'Set' if config.get('openai_api_key') else 'Not set'
        }
...
def initialize_ragas_if_needed(enable_reference_metrics: bool) -> None:
    ...
    """
    from utils.ragas_setup import setup_ragas  # Import here to avoid circular imports
    
    should_init = SessionStateManager.should_reinitialize_ragas(enable_reference_metrics)
