...
- [Product Brief (Global)](product-brief.md)
- [Product Brief (Intelligence Phase)](product-brief-intelligence-phase.md)
- [PRD](prd.md)
...
- [Stories](stories/)
  ...
  - [STORY-005: Parallel Retrieval](stories/STORY-005-mcp-parallel-retrieval.md)
  - [STORY-006: FlashRank Reranking](stories/STORY-006-mcp-flashrank-reranking.md)
  - [STORY-007: Semantic Cache](stories/STORY-007-rag-semantic-cache.md)
  - [STORY-008: Status Streaming](stories/STORY-008-unified-status-streaming.md)
...
- [Sprint Plans](.)
  - [Sprint 2: Unified System Phase 1](sprint-plan-002.md)
- [ADRs](adrs/)
  ...
  - [ADR-004: Unified Search (Parallel + Hybrid)](adrs/ADR-004-unified-search-parallel-hybrid.md)
  - [ADR-005: Orchestrator Performance (Caching + Streaming)](adrs/ADR-005-orchestrator-performance-caching-streaming.md)
- [Research Findings](research-findings/)
  - [V1: Initial Discoveries](research-findings/research-findings-v1.md)
  - [V6: Technical Deep Dive (Extraction & Chunking)](research-findings/research-findings-v6-technical-deep-dive.md)
